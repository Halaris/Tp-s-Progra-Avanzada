package testPrincipalParaProgDinamica;
...
public class Testeadora {
	...
	*/
	...
	/*
	@Test
	public void testGrado20000() // Evaluo el polinomio de grado 200 con x=2. //
	{
		double[] coeficientes = new double[20001];
		File archIn;
		Scanner sc;
		try
		{
			archIn=new File("Lote de pruebas\\casoDe20000.txt");
			sc=new Scanner(archIn);
		...
		Polinomio p=new Polinomio(20000,coeficientes);
		Calendar tIni, tFin;
		tIni = new GregorianCalendar();
		p.evaluarProgDinamica(2);
		tFin = new GregorianCalendar();
		long diff = tFin.getTimeInMillis() - tIni.getTimeInMillis();
		System.out.println("Polinomio de grado 20000 ->   Tiempo ejecución: " + diff + " ms");		
	}
	*/
	...
	/*
	@Test
	public void testGrado25000() // Evaluo el polinomio de grado 200 con x=2. //
	{
		double[] coeficientes = new double[25001];
		File archIn;
		Scanner sc;
		try
		{
			archIn=new File("Lote de pruebas\\casoDe25000.txt");
			sc=new Scanner(archIn);
		...
		Polinomio p=new Polinomio(25000,coeficientes);
		Calendar tIni, tFin;
		tIni = new GregorianCalendar();
		p.evaluarProgDinamica(2);
		tFin = new GregorianCalendar();
		long diff = tFin.getTimeInMillis() - tIni.getTimeInMillis();
		System.out.println("Polinomio de grado 25000 ->   Tiempo ejecución: " + diff + " ms");		
	}
	*/
	...
	/*
	@Test
	public void testGrado30000() // Evaluo el polinomio de grado 200 con x=2. //
	{
		double[] coeficientes = new double[30001];
		File archIn;
		Scanner sc;
		try
		{
			archIn=new File("Lote de pruebas\\casoDe30000.txt");
			sc=new Scanner(archIn);
		...
		Polinomio p=new Polinomio(30000,coeficientes);
		Calendar tIni, tFin;
		tIni = new GregorianCalendar();
		p.evaluarProgDinamica(2);
		tFin = new GregorianCalendar();
		long diff = tFin.getTimeInMillis() - tIni.getTimeInMillis();
		System.out.println("Polinomio de grado 30000 ->   Tiempo ejecución: " + diff + " ms");		
	}
	*/
	...
	/*
	@Test
	public void testGrado35000() // Evaluo el polinomio de grado 200 con x=2. //
	{
		double[] coeficientes = new double[35001];
		File archIn;
		Scanner sc;
		try
		{
			archIn=new File("Lote de pruebas\\casoDe35000.txt");
			sc=new Scanner(archIn);
		...
		Polinomio p=new Polinomio(35000,coeficientes);
		Calendar tIni, tFin;
		tIni = new GregorianCalendar();
		p.evaluarProgDinamica(2);
		tFin = new GregorianCalendar();
		long diff = tFin.getTimeInMillis() - tIni.getTimeInMillis();
		System.out.println("Polinomio de grado 35000 ->   Tiempo ejecución: " + diff + " ms");		
	}
	*/
	...
	///*
	@Test
	public void testGrado40000() // Evaluo el polinomio de grado 200 con x=2. //
	{
		double[] coeficientes = new double[40001];
		File archIn;
		Scanner sc;
		try
		{
			archIn=new File("Lote de pruebas\\casoDe40000.txt");
			sc=new Scanner(archIn);
		...
		Polinomio p=new Polinomio(40000,coeficientes);
		Calendar tIni, tFin;
		tIni = new GregorianCalendar();
		p.evaluarProgDinamica(2);
		tFin = new GregorianCalendar();
		long diff = tFin.getTimeInMillis() - tIni.getTimeInMillis();
		System.out.println("Polinomio de grado 40000 ->   Tiempo ejecución: " + diff + " ms");		
	}
	//*/
}
